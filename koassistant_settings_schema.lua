                ...
                -- Context Extraction settings
                {
                    ...
                    items = {
                        ...
                        },
                        {
                            ...
                            step = 10000,
                            precision = "%d",
                            help_text = _("Maximum characters to extract from the book (10,000-500,000). Higher values provide more context but use more tokens. Default: 100,000 (~25k tokens)."),
