                ...
                -- Context Extraction settings
                {
                    ...
                    items = {
                        ...
                        },
                        {
                            ...
                            step = 10000,
                            precision = "%d",
                            help_text = _("Maximum characters to extract from the book (10,000-1,000,000). Higher values provide more context but use more tokens. Default: 250,000 (~60k tokens)."),
                        ...
                        },
                        {
                            ...
                            help_text = _("Clear cached X-Ray and Recap responses for the current book. Use this to regenerate from scratch instead of updating from cache."),
