        ...
        -- Consolidates: chapter quiz, recap reminder, end-of-book, library scanning
        {
            ...
            items = {
                ...
                },
                {
                    ...
                    step = 1,
                    precision = "%d",
                    help_text = _("Skip the chapter-end quiz prompt for chapters shorter than this many pages (0 = always offer). Avoids quizzes on short or skimmed sections. Can be overridden per book in Book Settings."),
                    depends_on = { id = "enable_chapter_quiz", value = true },
                },
                {
