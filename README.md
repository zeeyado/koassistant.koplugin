...
>
> **Tip:** Hidden Flows is one of the best ways to save tokens and improve AI results. By hiding front matter, appendices, indices, and other non-narrative content, you send only the parts that matter. For collected works or anthologies, use Hidden Flows to isolate individual volumes or sections — a "Complete X-Ray" treats the visible content as the entire document, giving you a focused, high-quality analysis of just the part you're reading. See KOReader's documentation for how to set up Hidden Flows. *(Multi-X-Ray support — generating separate analyses for different sections of a book — is planned for a future release.)*
