...
Surface connections that enrich understanding, not tangential trivia. Be direct and concise. Keep it short, and don't restate the passage or explain what's already clear. Don't over-elaborate.]],
        include_book_context = true,
        api_params = {
            temperature = 0.7,
            max_tokens = 4096,
...
Be direct and concise. Keep it short, and don't restate the passage or explain what's already clear. Don't over-elaborate.]],
        skip_domain = true,
        api_params = {
            temperature = 0.6,
            max_tokens = 4096,
