...
- **Locations**: For significant locations, convey atmosphere and what unfolds there. Minor locations need only a brief note.
- **Themes**: Don't just name themes — trace how they develop through specific characters, conflicts, or events.
...
- **Locations**: Cities, regions, institutions, and historically significant places discussed in the text. For each, note what it is, its significance to the subject matter, and what events or arguments are connected to it.
- **Core Concepts**: For major concepts, explain both what they mean and how the author develops them — through what evidence, examples, or reasoning. Minor concepts need only a definition.
- **Arguments**: The author's key claims. For each, capture the argument itself, the evidence or reasoning supporting it, and any counter-arguments the author addresses.
- **Terminology**: Specialized vocabulary, jargon, or terms the author defines. Keep concise — this is reference material.
- **Argument Development**: Track the intellectual progression — how the argument unfolds chapter by chapter. Each entry should show how it advances the thesis or shifts the discussion.
