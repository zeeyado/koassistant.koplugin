...
Actions.library = {
    ...
    analyze_library = {
        ...
        description = _("Analyzes your library to reveal genres and authors you gravitate toward, completion patterns, and gaps in your collection. When advanced stats are enabled, includes engagement insights like which books you spent the most time on."),
        context = "library",
        skip_domain = true,
        use_library = true,
        use_advanced_stats = true,
