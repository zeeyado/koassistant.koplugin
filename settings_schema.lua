                    ...
                    items = {
                        {
                            ...
                            info_text = _("Resets provider, model, temperature, and other toggles to defaults.\n\nPreserves: API keys, custom actions, behaviors, custom models, chat history."),
                            confirm = true,
                            confirm_text = _("Reset feature settings to defaults?\n\nThis will reset provider, model, temperature, and other toggles.\n\nAPI keys, custom actions, behaviors, and chat history will be preserved."),
                        ...
                        },
                        {
                            ...
                            info_text = _("Resets ALL settings including custom actions, behaviors, domains, models, and action overrides.\n\nPreserves: API keys, chat history."),
                            confirm = true,
                        ...
                        },
                        {
                            ...
                            info_text = _("Deletes all saved chat conversations across all books."),
                            confirm = true,
                            confirm_text = _("Delete all chat history?\n\nThis will remove all saved conversations across all books.\n\nThis cannot be undone."),
