...
function OpenRouterHandler:query(message_history, config)
    ...
    if config and config.features and config.features.debug then
        print("OpenRouter Request Body:", json.encode(request_body))
    ...
    if config and config.features and config.features.debug then
        print("OpenRouter Raw Response:", table.concat(responseBody))
    end
    ...
    if config and config.features and config.features.debug then
        print("OpenRouter Parsed Response:", json.encode(response))
    end
