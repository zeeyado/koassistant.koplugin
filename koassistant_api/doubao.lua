...
function DoubaoHandler:query(message_history, config)
    ...
    if config and config.features and config.features.debug then
        print("Doubao Request Body:", json.encode(request_body))
    ...
    if config and config.features and config.features.debug then
        print("Doubao Raw Response:", table.concat(responseBody))
    end
    ...
    if config and config.features and config.features.debug then
        print("Doubao Parsed Response:", json.encode(response))
    end
