...
function MistralHandler:query(message_history, config)
    ...
    if config and config.features and config.features.debug then
        print("Mistral Request Body:", json.encode(request_body))
    ...
    if config and config.features and config.features.debug then
        print("Mistral Raw Response:", table.concat(responseBody))
    end
    ...
    if config and config.features and config.features.debug then
        print("Mistral Parsed Response:", json.encode(response))
    end
