-- DEPRECATED: This module is replaced by prompts/actions.lua
-- Kept for backwards compatibility during transition period.
-- New code should use ActionService with prompts/actions.lua instead.
--
-- Built-in prompts for the KOAssistant plugin
